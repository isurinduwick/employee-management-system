...
class AppColors {
  ...
  /// The brand mark's gradient runs from [accent] into this deeper tone.
  static const accentDeep = Color(0xFF0B3F5F);
...
/// The 4pt spacing scale the shared widgets lay out against, so padding stays
/// consistent between screens written by different hands.
class AppSpacing {
  const AppSpacing._();
